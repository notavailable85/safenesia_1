class TrainingLocation {
  ...
  static List<TrainingLocation> dummyLocations = [
    TrainingLocation(
      ...
      alamat: 'Wisma Presisi Lantai 1 No.4B, Jl. Taman Aries, RT.005/RW.002 Meruya Utara, Kembangan, Jakarta Barat, DKI Jakarta 11620',
      kelurahan: 'Meruya',
      kecamatan: 'Kembangan',
      ...
      qrCodeLokasi: 'https://image-charts.com/chart?chs=200x200&cht=qr&chl=https://maps.app.goo.gl/Ffa6ArGPNGf1ZoFN6',
    ),
    TrainingLocation(
      id: 2,
      namaLokasi: 'LPK K3',
      alamat: 'Jl. Gempol Raya, RT.001/RW.002, Kunciran, Pinang, Kota Tangerang, Banten 15144',
      kelurahan: 'Kunciran',
      kecamatan: 'Pinang',
      ...
      qrCodeLokasi: 'https://image-charts.com/chart?chs=200x200&cht=qr&chl=https://maps.app.goo.gl/xD8ybdbA3bXaFG8Q6',
    ),
    TrainingLocation(
      id: 3,
      namaLokasi: 'GSI Training Center',
      alamat: 'Gg. Cemara, RT.002/RW.007, Bubulak, Bogor Barat, Kota Bogor, Jawa Barat 16115',
      kelurahan: 'Bubulak',
      ...
      qrCodeLokasi: 'https://image-charts.com/chart?chs=200x200&cht=qr&chl=https://maps.app.goo.gl/rkYYN4MNG5yvUNtc9',
    ),
    TrainingLocation(
      id: 4,
      namaLokasi: 'The Acacia Hotel Jakarta',
      alamat: 'Jl. Kramat Raya No.81, RT.001/RW.007, Kramat, Senen, Jakarta Pusat, DKI Jakarta 10450',
      kelurahan: 'Kramat',
      kecamatan: 'Senen',
      ...
      qrCodeLokasi: 'https://image-charts.com/chart?chs=200x200&cht=qr&chl=https://maps.app.goo.gl/iAv2mApms4afFfVk7',
    ),
    TrainingLocation(
      id: 5,
      namaLokasi: 'Universitas Indonesia',
      alamat: 'Jl. Lingkar, Pondok Cina, Kec. Beji, Kota Depok, Jawa Barat 16424',
      ...
      qrCodeLokasi: 'https://image-charts.com/chart?chs=200x200&cht=qr&chl=https://maps.app.goo.gl/C37NDKJvfUpimLvHA',
    ),
    TrainingLocation(
      id: 6,
      namaLokasi: '88 Hotel Bekasi',
      alamat: 'Jl. Cut Mutia No.139, RT.001/RW.002, Sepanjang Jaya, Rawalumbu, Kota Bekasi, Jawa Barat 17114',
      ...
      qrCodeLokasi: 'https://image-charts.com/chart?chs=200x200&cht=qr&chl=https://maps.app.goo.gl/iGEkWhSXBBiXXLHb9',
    ),
    TrainingLocation(
      id: 7,
      namaLokasi: 'Amaris Hotel Cilegon',
      alamat: 'Jl. SA. Tirtayasa No.17, Jombang Wetan, Jombang, Kota Cilegon, Banten 42411',
      ...
      qrCodeLokasi: 'https://image-charts.com/chart?chs=200x200&cht=qr&chl=https://maps.app.goo.gl/pJ5KEae4Fcqv6mm57',
    ),
    TrainingLocation(
      id: 8,
      namaLokasi: 'Grand Serela Setiabudhi Bandung',
      alamat: 'Jl. Hegarmanah No.15 No. 9, Hegarmanah, Cidadap, Kota Bandung, Jawa Barat 12630',
      ...
      qrCodeLokasi: 'https://image-charts.com/chart?chs=200x200&cht=qr&chl=https://maps.app.goo.gl/pNgEtGs2BtfqpLnYA',
    ),
    TrainingLocation(
      id: 9,
      namaLokasi: 'UC Hotel UGM',
      alamat: 'Hotel & Convention, Bulaksumur Jl. Pancasila No.2, Sendowo, Sinduadi, Depok, Sleman, D.I. Yogyakarta 55281',
      kelurahan: 'Sinduadi',
      kecamatan: 'Depok',
      ...
      qrCodeLokasi: 'https://image-charts.com/chart?chs=200x200&cht=qr&chl=https://maps.app.goo.gl/rj3EvzZTr6msn58Q6',
    ),
  ];
}
