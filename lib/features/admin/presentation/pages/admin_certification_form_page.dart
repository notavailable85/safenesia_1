...
class AdminCertificationFormPage extends StatefulWidget {
  ...
  @override
  State<AdminCertificationFormPage> createState() =>
      _AdminCertificationFormPageState();
}

class _AdminCertificationFormPageState
    extends State<AdminCertificationFormPage> {
  ...
  void initState() {
    ...
    bannerUrl = widget.certification?.bannerUrl ?? '';
  }
        ...
        child: ListView(
          ...
          children: [
            ...
            TextFormField(
              ...
              decoration: const InputDecoration(
                labelText: 'Banner URL (Opsional)',
                border: OutlineInputBorder(),
              ),
              onChanged: (value) => bannerUrl = value,
            ),
