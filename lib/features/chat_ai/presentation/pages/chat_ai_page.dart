...
class _ChatAiPageState extends State<ChatAiPage> {
  ...
  void initState() {
    ...
    _messages.add(
      ChatMessage(
        text: 'Halo! Saya Asisten K3 Safenesia. Ada yang bisa saya bantu terkait Keselamatan dan Kesehatan Kerja hari ini?',
        isUser: false,
  ...
  String _getDummyResponse(String input) {
    ...
    } else if (lower.contains('pagi') || lower.contains('siang') || lower.contains('sore') || lower.contains('malam')) {
      return 'Selamat ${lower.contains('pagi') ? 'pagi' : lower.contains('siang') ? 'siang' : lower.contains('sore') ? 'sore' : 'malam'}! Semoga Anda selalu dalam keadaan aman dan sehat. Ada yang ingin didiskusikan terkait Keselamatan Kerja?';
    } else if (lower.contains('siapa kamu') || lower.contains('nama kamu') || lower.contains('kamu siapa')) {
    ...
    // K3 & DEFINITIONS
    else if (lower.contains('apa itu k3') || (lower.contains('k3') && lower.contains('pengertian'))) {
    ...
    else if (lower.contains('cara daftar') || lower.contains('pesan pelatihan') || lower.contains('beli')) {
    ...
    } else if (lower.contains('membership') || lower.contains('platinum') || lower.contains('kartu')) {
    ...
    else if (lower.contains('apd') || lower.contains('alat pelindung') || lower.contains('helm')) {
    ...
    } else if (lower.contains('kecelakaan') || lower.contains('insiden') || lower.contains('lapor')) {
    ...
    } else if (lower.contains('riksa uji') || lower.contains('inspeksi') || lower.contains('alat berat')) {
    ...
    } else if (lower.contains('regulasi') || lower.contains('undang-undang') || lower.contains('uu no 1')) {
        ...
        title: Row(
          children: [
            ...
            Column(
              ...
              children: [
                Text('Chat AI', style: GoogleFonts.inter(fontWeight: FontWeight.bold, fontSize: 16)),
                const Text('Online - K3 Assistant', style: TextStyle(fontSize: 12, color: Colors.white70)),
              ],
            ),
          ],
        ),
